...
//if (isset($_POST['registrar'])) {
    ...
    if (empty($_POST['user']) || empty($_POST['fname']) || empty($_POST['lname']) || empty($_POST['mail']) || empty($_POST['pass'])) {
        ...
        if( mysqli_num_rows($q) == 0){
            ...
            $sql = "INSERT INTO usuario(CodigoUsuario, NombreUsuario, Nombres, Apellidos, Correo, Clave, Tipo, Direccion) 
                VALUES ('$codigo', '$usuario', '$nombre', '$apellido', '$correo', '$clave', '$tipo', '$direccion')";

                                ...
                                <div class="col-lg-7">
                                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                        <div class="card-header">
                                            <h3 class="text-center font-weight-light my-4">Actualizar Producto</h3>
                                        </div>
                                        <div class="card-body">
                                            <form action="../bd/producto/administrar_producto.php" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control py-4" id="inputUserName" name="nombre" type="text" aria-describedby="emailHelp" value="<?php echo $producto->getNombre()?>" required />
                                                </div>
                                                <div class="form-group">
                                                    <label class="small mb-1" for="inputEmailAddress">Nombre Científico</label>
                                                    <input class="form-control py-4" id="inputUserName" name="nombrec" type="text" aria-describedby="emailHelp" value="<?php echo $producto->getNombrec()?>" required />
                                                </div>
                                                <div class="form-group">
	                                                <label class="small mb-1" for="inputAddress">Descripción del producto</label>
	                                                <textarea class="form-control" name="descripcion" id="exampleFormControlTextarea1" rows="3"><?php echo $producto->getDescripcion()?></textarea>
	                                            </div>
